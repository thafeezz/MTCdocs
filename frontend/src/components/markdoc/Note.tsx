...
export const Tip = ({ children }: AlertProps) => {
  return (
    <div className="rounded-lg bg-emerald-50/85 p-4 my-2 border-2 border-emerald-300">
...
export const Note = ({ children }: AlertProps) => {
  return (
    <div className="rounded-lg bg-blue-50/85 p-4 my-2 border-2 border-blue-300">
      <div className="flex items-start gap-2">
...
export const Alert = ({ children }: AlertProps) => {
  return (
    <div className="rounded-lg bg-red-200/85 p-4 my-2 border-2 border-red-300">
      <div className="flex items-start gap-2">
